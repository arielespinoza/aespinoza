<!-- home app -->
<div class="modal fade" id="levitar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        ...
        <header class="header levitar">
          <div class="tituloProyecto">
            ...
            <p class="text-white mtop0">Diseño y Desarrollo de Web corporativa</p>
          </div>
        </header>
        <!-- header -->
        <!-- inicio -->
