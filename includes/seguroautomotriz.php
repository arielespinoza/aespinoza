<!-- home app -->
<div class="modal fade" id="seguroAuto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <section class=" pv100">
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-lg-4 col-sm-12 text-center nopadding">
                <img src="img/seguroauto-diseno2.png" alt="ui" class="max100">
              </div> 
              <div class="col-md-4 col-lg-4 col-sm-12 text-center nopadding">
                <img src="img/seguroauto-diseno3.png" alt="ui" class="max100">
              </div> 
            </div>
          </div>
        </section>
