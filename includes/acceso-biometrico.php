<!-- home app -->
<div class="modal fade" id="accesoBiometrico" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-6 col-lg-6 col-sm-12  text-center">
                <img src="img/destacado-biometrico.png" alt="iamgen proyecto" class="max100">
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-5 col-lg-5 col-sm-12 text-center">
                  <div class="pd30 contentWireframe">
                    ...
                    <img src="img/biometrico-wireframe1.jpg" alt="bocetos" class="max100">
                  </div>
                </div>
              </div>
            </div>
        ...
        <section class="design pv100">
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-lg-4 col-sm-12 text-center nopadding">
                <img src="img/biometrico-diseno2.png" alt="ui" class="max100">
              </div> 
              <div class="col-md-4 col-lg-4 col-sm-12 text-center nopadding">
                <img src="img/biometrico-diseno3.png" alt="ui" class="max100">
              </div> 
            </div>
          </div>
        </section>
