      ...
      <div class="modal-body">
              ...
              <div class="row">
                <div class="col-md-12 col-lg-12 col-sm-12 text-center">
                  <div class="pd30">
                    ...
                    <img src="img/altainmediata-boceto1.jpg" alt="bocetos" class="max100">
                  </div>
                </div>
              </div>
            </div>
        ...
        <section class="bocetos pv100">
          <div class="container text-center">
            <iframe id="iframe" width="65%" height="400" src="https://www.youtube.com/embed/NN-aGVDcaB4?rel=0&showinfo=0" frameborder="0" allowfullscreen></iframe>
          </div>
        </section>
        <!-- video -->
